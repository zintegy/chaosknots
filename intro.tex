...
Note that if a template $\tau$ admits a renormalization, then the image of that renormalization (being diffeormophic to the original template) can again be renormalized, giving an increasingly complicated sequence of embedded
